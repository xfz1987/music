;(function(){
    ...
    this.sliderNode = options.sliderNode;
    this.downLoadNode = options.downLoadNode;
	...
	MusicPlay.prototype = {
      ...
      this.downLoadNode.href = songObj.src;
      this.downLoadNode.download = songObj.title + '.mp3';
		},
		_initEvent: function(){
			var _this = this;
      ...
      this.progressBarNode.addEventListener('click', function(e){
      	...
      	_this.sliderNode.style.left = percent * 100 + "%";
      }, false);
		},
		loadNPMusic(type){
			if(type == 'next'){
      ...
      this.sliderNode.style.left = percent;
